...
- If you are asked to compare items in the game, be sure to include all the imformation you can about them including price, stats, armament(s), utility information, seating capacity, strengths, weaknesses, unlock method, and unlock details if available in the context.
