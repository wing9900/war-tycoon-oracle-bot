...
- If you are asked to compare items in the game, be sure to include all the important imformation, including the price, stats, armament(s), utility information, seating capacity, strengths, weaknesses, unlock method, and unlock details FOR EACH OF THE ITEMS if available in the context.
